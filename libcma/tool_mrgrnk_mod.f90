      ...
      !-------------------------------------------------------------------------
      !
      !  Purpose      : This module contains a subroutine for ranking vectors
      !					in ascending order
      !                
      !  Remarks      : 
      !
      !  References   : This Module is part of ORDERPACK 2.0
