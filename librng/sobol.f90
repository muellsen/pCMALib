      ...
      !  Parameters:
      !
      !    Input, integer ( ki4 ) N, the integer to be measured.
      !    N should be nonnegative.  If N is nonpositive, I4_BIT_HI1
      !    will always be 0.
      !
      !    Output, integer ( ki4 ) I4_BIT_HI1, the number of bits base 2.
      !
        USE kinds
      implicit none

      integer ( ki4 ) bit
      integer ( ki4 ) i4_bit_hi1
      integer ( ki4 ) i
      integer ( ki4 ) n
      ...
      !
      !    Output, integer ( ki4 ) I4_BIT_LO0, the position of the low 1 bit.
      !
        USE kinds
      implicit none
      ...
      !  Parameters:
      !
      !    Input, integer ( ki4 ) DIM_NUM, the number of spatial dimensions.
      !    DIM_NUM must satisfy 1 <= DIM_NUM <= 1111.
      !
      !    Input/output, integer ( ki4 ) SEED, the "seed" for the sequence.
      ...
      !
      !    Output, real ( kr4 ) QUASI(DIM_NUM), the next quasirandom vector.
      !
        USE kinds
      implicit none

      integer ( ki4 ) dim_num
      integer ( ki4 ), parameter :: dim_max = 1111
      integer ( ki4 ), parameter :: log_max = 30

      integer ( ki4 ) atmost
      integer ( ki4 ), save :: dim_num_save = 0
      integer ( ki4 ) i
      integer ( ki4 ) i4_bit_hi1
      integer ( ki4 ) i4_bit_lo0
      integer ( ki4 ) inc
      ...
      integer ( ki4 ) k
      integer ( ki4 ) l
      integer ( ki4 ), save, dimension(dim_max) :: lastq
      integer ( ki4 ) m
      integer ( ki4 ), save :: maxcol
      integer ( ki4 ) newv
      integer ( ki4 ), save, dimension(1:dim_max) :: poly
      real    ( kr4 ) quasi(dim_num)
      real    ( kr4 ), save :: recipd
      integer ( ki4 ) seed
      integer ( ki4 ), save :: seed_save = - 1
      integer ( ki4 ) seed_temp
      integer ( ki4 ), save, dimension(1:dim_max,1:log_max) :: v
      ...
      !
      quasi(1:dim_num) = real ( lastq(1:dim_num), kr4 ) * recipd
      lastq(1:dim_num) = ieor ( lastq(1:dim_num), v(1:dim_num,l) )
      ...
      !  Parameters:
      !
      !    Input, integer ( ki4 ) M, the spatial dimension.
      !
      !    Input, integer ( ki4 ) N, the number of points to generate.
      !
      !    Input, integer ( ki4 ) SKIP, the number of initial points to skip.
      !
      !    Output, real ( kr4 ) R(M,N), the points.
      !
        USE kinds
      implicit none
      ...
      !    components of the SKIP+I-1 entry of the Sobol sequence.
      !
      !    For the Sobol sequence, the value of SKIP is the same
      ...
      if ( ios /= 0 ) then
        write ( *, '(a)' ) ' '
        write ( *, '(a)' ) 'I4_SOBOL_WRITE - Fatal error!'
      ...
      write ( file_out_unit, '(a)'       ) '#  created by I4_SOBOL_WRITE.F90.'
      write ( file_out_unit, '(a)'       ) '#'
      write ( file_out_unit, '(a)'       ) '#  File generated on ' &
        // trim ( string )
      write ( file_out_unit, '(a)'       ) '#'
      write ( file_out_unit, '(a,i8)'    ) '#  Spatial dimension M = ', m
      ...
      write ( string, '(a,i3,a)' ) '(', m, '(2x,f10.6))'
      do j = 1, n
      ...
      !  Parameters:
      !
      !    Input, integer ( ki4 ) A, B, the limits of the interval.
      !
      !    Input/output, integer ( ki4 ) SEED, the "seed" value, which
      !    should NOT be 0.  On output, SEED has been updated.
      !
      !    Output, integer ( ki4 ) I4_UNIFORM, a number between A and B.
      !
        USE kinds
      implicit none
      ...
      r = real ( seed, kr4 ) * 4.656612875E-10
      !
      !  Scale R to lie between A-0.5 and B+0.5.
      !
      r = ( 1.0E+00 - r ) * ( real ( min ( a, b ), kr4 ) - 0.5E+00 ) & 
        +           r   * ( real ( max ( a, b ), kr4 ) + 0.5E+00 )
      !
      ...
      !  Discussion:
      !
      !    This function is NOT needed in FORTRAN90, which supplies the
      !    intrinsic IEOR function for this purpose.
      !
      !  Licensing:
      !
      !    This code is distributed under the GNU LGPL license. 
      ...
      !  Parameters:
      !
      !    Input, integer ( ki4 ) I, J, two values whose exclusive OR is needed.
      !
      !    Output, integer ( ki4 ) I4_XOR, the exclusive OR of I and J.
      !
        USE kinds
      implicit none
      ...
      !  Parameters:
      !
      !    Input, integer ( ki8 ) N, the integer to be measured.
      !    N should be nonnegative.  If N is nonpositive, I8_BIT_HI1
      !    will always be 0.
      !
      !    Output, integer ( ki8 ) I8_BIT_HI1, the number of bits base 2.
      !
        USE kinds
      implicit none

      integer ( ki8 ) :: bit
      integer ( ki8 ) :: i8_bit_hi1
      integer ( ki8 ) :: i
      integer ( ki8 ) :: n
      ...
      !    N should be nonnegative.
      !
      !    Output, integer ( ki8 ) I8_BIT_LO0, the position of the low 1 bit.
      !
        USE kinds
      implicit none
      ...
      !  Parameters:
      !
      !    Input, integer ( ki8 ) DIM_NUM, the number of spatial dimensions.
      !    DIM_NUM must satisfy 1 <= DIM_NUM <= 1111.
      !
      !    Input/output, integer ( ki8 ) SEED, the "seed" for the sequence.
      !    This is essentially the index in the sequence of the quasirandom
      !    value to be generated.  On output, SEED has been set to the
      !    appropriate next value, usually simply SEED+1.
      !    If SEED is less than 0 on input, it is treated as though it were 0.
      ...
      integer ( ki8 ) :: dim_num
      integer ( ki8 ), parameter :: dim_max = 1111
      integer ( ki8 ), parameter :: log_max = 62

      integer ( ki8 ) :: atmost
      integer ( ki8 ), save :: dim_num_save = 0
      integer ( ki8 ) :: i
      integer ( ki8 ) :: i8_bit_hi1
      integer ( ki8 ) :: i8_bit_lo0
      integer ( ki8 ) :: inc
      ...
      integer ( ki8 ) :: k
      integer ( ki8 ) :: l
      integer ( ki8 ), save, dimension(dim_max) :: lastq
      integer ( ki8 ) :: m
      integer ( ki8 ), save :: maxcol
      integer ( ki8 ) :: newv
      integer ( ki8 ), save, dimension(1:dim_max) :: poly
      real    ( kr8 ), dimension ( dim_num ) :: quasi
      real    ( kr8 ), save :: recipd
      integer ( ki8 ) ::  seed
      integer ( ki8 ), save :: seed_save = - 1
      integer ( ki8 ) ::  seed_temp
      integer ( ki8 ), save, dimension(1:dim_max,1:log_max) :: v
      ...
      !  Calculate the new components of QUASI.
      !
      quasi(1:dim_num) = real ( lastq(1:dim_num), kr8 ) * recipd
      lastq(1:dim_num) = ieor ( lastq(1:dim_num), v(1:dim_num,l) )
      ...
      !
      !    Input, integer ( ki8 ) SKIP, the number of initial points to skip.
      !
      !    Output, real ( kr8 ) R(M,N), the points.
      !
        USE kinds
      implicit none
      ...
      !  Parameters:
      !
      !    Input, integer ( ki8 ) M, the spatial dimension.
      !
      !    Input, integer ( ki8 ) N, the number of (successive) points.
      !
      !    Input, integer ( ki8 ) SKIP, the number of skipped points.
      !
      !    Input, real ( kr8 ) R(M,N), the points.
      !
      !    Input, character ( len = * ) FILE_OUT_NAME, the name of
      !    the output file.
      !
      ...
      if ( ios /= 0 ) then
        write ( *, '(a)' ) ' '
        write ( *, '(a)' ) 'I8_SOBOL_WRITE - Fatal error!'
        write ( *, '(a)' ) '  Could not open the output file.'
        stop
      end if
      ...
      write ( file_out_unit, '(a)'       ) '#  ' // trim ( file_out_name )
      write ( file_out_unit, '(a)'       ) '#  created by I8_SOBOL_WRITE.F90.'
      write ( file_out_unit, '(a)'       ) '#'
      write ( file_out_unit, '(a)'       ) '#  File generated on ' &
        // trim ( string )
      write ( file_out_unit, '(a)'       ) '#'
      ...
      !  Parameters:
      !
      !    Input, integer ( ki8 ) A, B, the limits of the interval.
      !
      !    Input/output, integer ( ki8 ) SEED, the "seed" value, which 
      !    should NOT be 0.  On output, SEED has been updated.
      !
      !    Output, integer ( ki8 ) I8_UNIFORM, a number between A and B.
      !
        USE kinds
      implicit none
      ...
      integer ( ki8 ) a
      integer ( ki8 ) b
      integer ( ki8 ) i8_uniform
      real    ( kr8 ) r
      real    ( kr8 ) r8i8_uniform_01
      integer ( ki8 ) seed
      integer ( ki8 ) value
      ...
      !  Scale R to lie between A-0.5 and B+0.5.
      !
      r = ( 1.0D+00 - r ) * ( real ( min ( a, b ), kr8 ) - 0.5D+00 ) & 
        +           r   * ( real ( max ( a, b ), kr8 ) + 0.5D+00 )
      !
      !  Use rounding to convert R to an integer between A and B.
      !
      value = nint ( r, ki8 )
      ...
      !  Parameters:
      !
      !    Input, integer ( ki8 ) I, J, two values whose exclusive OR is needed.
      !
      !    Output, integer ( ki8 ) I8_XOR, the exclusive OR of I and J.
      !
        USE kinds
      implicit none
      ...
      !  Parameters:
      !
      !    Input/output, integer ( ki8 ) SEED, the "seed" value, which should
      !    NOT be 0. On output, SEED has been updated.
      !
      !    Output, real ( kr8 ) R8I8_UNIFORM_01, a new pseudorandom variate,
      ...
      r8i8_uniform_01 = real ( seed, kr8 ) * 4.656612875D-10
      ...
      !  Parameters:
      !
      !    Input, integer ( ki4 ) DIM_NUM, the spatial dimension.  Only values
      !    of 1 through 13 will result in useful responses.
      !
      !    Output, integer ( ki4 ) TAU_SOBOL, the value TAU.
      !
        USE kinds
      implicit none

      integer ( ki4 ), parameter :: dim_max = 13

      integer ( ki4 ) dim_num
      integer ( ki4 ), save, dimension ( dim_max ) :: tau = (/ &
         0,  0,  1,  3,  5, &
         8, 11, 15, 19, 23, &
        27, 31, 35 /)
      integer ( ki4 ) tau_sobol
