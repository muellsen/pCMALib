...
!
  ...
  write ( *, '(a)' ) '  Test the routines in the HALTON library.'
...
!
  ...
  integer seed(dim_max)
  integer, dimension ( test_num ) :: step_vec = (/ 0, 5, 1000, 1000000 /)
  integer step
  integer test
